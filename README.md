...
```bash
go get -u github.com/dgoodman91/iothub
```

To install CLI applications:

```bash
GO111MODULE=on go get -u github.com/dgoodman91/iothub/cmd/{iothub-service,iothub-device}
```
...
import (
	...
	"github.com/dgoodman91/iothub/iotservice"
)
...
[cmd/iothub-service](https://github.com/dgoodman91/iothub/blob/master/cmd/iothub-service) and [cmd/iothub-device](https://github.com/dgoodman91/iothub/blob/master/cmd/iothub-device) are reference implementations of almost all available features. 
